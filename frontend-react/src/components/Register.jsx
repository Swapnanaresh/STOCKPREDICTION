...
const Register = () => {
  ...
  const handleRegistration = async (e) =>{
    ...
    try{
      const responce = await axios.post('http://127.0.0.1:8000/api/v1/register/', userData)
      ...
      <div className='row justify-content-center'>
        <div className='col-md-6 bg-light-dark p-5 rounded'>
          ...
          <form onSubmit={handleRegistration}>
            ...
            {loading ? (
            <button type='submit' className='btn btn-info d-block mx-auto' disable>Please wait...</button>
            ):(
